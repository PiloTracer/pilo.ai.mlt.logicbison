...
|--------|--------|-----|-------|-------|
| M1: Math for ML | [ ] | Gradient descent in pure NumPy + loss-landscape visualization — **done 2026-08-04, pass** (artifacts: `../../labs/grad-descent/`) | - | Entry point if math is the deepest gap |
| M2: Python for ML | [ ] | Real dataset: clean, feature-engineer, visualize | - | |
| M3: ML Basics | [ ] | UCI Adult Income classification pipeline with CV + metrics | - | Program capstone lab |

## Exit criteria ledger

| Criterion | Pass condition | Met |
|-----------|----------------|-----|

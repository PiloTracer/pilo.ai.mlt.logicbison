...
## Learner annotations (example — filled at install from PROFILE)

- **Pacing:** catalog assumes 3–4 sessions/week; adjust week labels to the learner's real budget (e.g. at 2 h/week one catalog "week" ≈ 3–4 calendar weeks).
- **Entry point:** if math is the deepest gap (common), Module 1 must not be skimmed.
- **Goal alignment:** for terminology-first learners, Modules 1→3 serve directly; do not inject LLM content here — it belongs to later catalog programs.

...
- **Learner memory (local):** `.training.mlt/` in this repo — context (profile, handoff), plans, programs, sessions, sources, labs, tutorials, drills, exports. Never write MLT learner artifacts outside it. Session logs follow `YYYY-MM-DD_<topic-slug>.md` naming; labs live under `labs/<topic>/`.

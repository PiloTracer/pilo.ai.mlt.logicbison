...
**Sources:** [Anthropic Tool Use](https://docs.anthropic.com/en/docs/build-with-claude/tool-use) · [MCP Specification](https://modelcontextprotocol.io/) · [OpenAI Function Calling](https://platform.openai.com/docs/guides/function-calling) · [LangChain Tools](https://python.langchain.com/docs/concepts/tools/)
...
**Sources:** [Anthropic Eval Guide](https://docs.anthropic.com/en/docs/test-and-evaluate/) · [Braintrust](https://www.braintrust.dev/docs) · [LangSmith](https://docs.smith.langchain.com/evaluation)
...
**Lab:** Gradio demo for multi-agent system: streaming, conversation history, file upload, example gallery. Deploy to HF Spaces.
...
**Exit check:** Deployed demo with streaming, examples, and graceful error handling.
...
| Demo | Deployed with streaming, examples, error handling |

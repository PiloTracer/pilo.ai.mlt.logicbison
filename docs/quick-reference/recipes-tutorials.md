...
Produces an ordered watch list of durable, reputable YouTube videos (per `standards/citation.md`), each with "what to extract" cues and a synthesis-recall section — zero code, all intuition. Example shipped in the framework: `.work.mlt/tutorials/20260804-learn-today/gradient-descent-video-entry.md`.
...
| Layout | Path |
|--------|------|
| Single | `.work.mlt/tutorials/<topic-slug>.md` |
| Bundle | `.work.mlt/tutorials/<YYYYMMDD>-<slug>/<part>.md` |
